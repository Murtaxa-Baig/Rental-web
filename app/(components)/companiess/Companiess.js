    ...
    return (
        <>
            ...
            <div className='border-[1px] border-gray-200 my-5 rounded-sm p-3'>
                <p className='text-sm text-gray-500'>Please specify company data here. We draw your attention that you can specify data of several companies and choose default company data</p>
            </div>

            <div className='flex items-center w-full justify-between'>
                <div className='flex items-center p-2 w-[49%]'>
                    <Image
                        src={profile}
                        height={75}
                        width={75}
                    ...
                    <div className='px-4'>
                        ...
                        <p className='text-sm text-gray-500'>Via Foro S. Martino, 22, 21012 Cassano Magnago VA, Italy</p>
                        <button className='px-2 bg-green-100 rounded-sm text-green-400 text-sm font-bold'>Default company</button>
                    </div>
                ...
                <div className='flex items-center p-2 w-[49%]'>
                    ...
                    <div className='px-4'>
                        <button onClick={() => setShowModal(true)} className='font-bold text-blue-600'>New Company</button>
            ...
            <div className='flex items-center w-full justify-between'>
                ...
                <div className='flex items-center p-2 w-[49%]'>
                    ...
                    <div className='px-4'>
                        <button onClick={() => setShowOfficeModal(true)} className='font-bold text-blue-600'>Add office</button>
                        <p className='text-sm text-gray-500'>Company address</p>
                    </div>
                </div>
                {
